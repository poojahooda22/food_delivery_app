                    ...
                    {constants.delivery_time.map((item, index) => {
                        return (
                            <TextButton
                                ...
                                label={item.label}
                                labelStyle={{
                                    color: item.id == deliveryTime ? COLORS.white : COLORS.gray, ...FONTS.body3
                                }}
                                buttonContainerStyle={{
                                    ...
                                    backgroundColor: item.id == deliveryTime ? COLORS.primary : COLORS.gray2
                                }}
                        ...
                        return (
                            <TextIconButton
                                ...
                                containerStyle={{
                                    ...
                                    alignItems: 'center',
                                    borderRadius: SIZES.base,
                                    backgroundColor: item.id == ratings ? COLORS.primary : 
                                    COLORS.lightGray2   
                                }}
                                label={item.label}
                                labelStyle={{
                        ...
                        return (
                            <TextButton
                                ...
                                buttonContainerStyle={{
                                    ...
                                    alignItems: 'center',
                                    borderRadius: SIZES.base,
                                    backgroundColor: item.id == tags ? COLORS.primary : COLORS.gray2
                                }}
